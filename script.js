document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showError(field, message) {
      const wrapper = field.closest('.form-group, .field-wrapper, .form-field') || field.parentElement;
    ...
    function validateField(field) {
      if (field.type === 'submit' || field.type === 'button' ||
          field.type === 'reset' || field.type === 'hidden') return true;
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (validateForm()) {
        ...
        setTimeout(function () {
          ...
          const wrappers = contactForm.querySelectorAll(
            '.form-group, .field-wrapper, .form-field'
          );
          wrappers.forEach(function (w) {
            w.classList.remove(FIELD_SUCCESS_CLASS, FIELD_ERROR_CLASS);
          });
  ...
  const animationTargets = document.querySelectorAll(OBSERVE_SELECTOR);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c94938c0-49ba-4392-ab07-50aca0748e2d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c94938c0-49ba-4392-ab07-50aca0748e2d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c94938c0-49ba-4392-ab07-50aca0748e2d';
